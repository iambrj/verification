...
// Transition System
method FiboRecTransitionSystem(initialState:StateSpace) returns (terminalState:StateSpace)
    decreases initialState.a
// pre-conditions:
    requires initialState.a >= 0
    requires initialState.b >= 0
    requires initialState.c >= 1
    requires initialState.d >= initialState.a
    requires initialState.c >= initialState.b
// post-conditions:
    //ensures terminalState.b == fibo(initialState.d - initialState.a)
{
    if initialState.a < 1
    {
        terminalState := StateSpace(0, initialState.b, initialState.c,
                               initialState.d);
        //assert terminalState.b == fibo(initialState.d - initialState.a);
        //print("initialState.d - initialState.a\t\t\t\tterminalState.b\t\tfibo(initialState.d - initialState.a)\n");
        //print(initialState.d - initialState.a);
        //print("\t\t\t");
        //print(terminalState.b);
        //print("\t\t\t");
        //print(fibo(initialState.d - initialState.a));
        //print("\n");
    }
    else
    {
        terminalState := FiboRecTransitionSystem(StateSpace(initialState.a - 1,
                                   initialState.c, initialState.b +
                                   initialState.c, initialState.d));
        //assert terminalState.b == fibo(initialState.d);
        //print("initialState.a\t\t\tterminalState.b\t\tfibo(initialState.d)\n");
        //print(initialState.d);
        //print("\t\t\t");
        //print(terminalState.b);
        //print("\t\t\t");
        //print(fibo(initialState.d));
        //print("\n");
    }
    //assert terminalState.b == fibo(initialState.d);
    //print("initialState.d\t\tterminalState.b\t\tfibo(initialState.d)\n");
    //print(initialState.d);
    //print("\t\t\t");
    //print(terminalState.b);
    //print("\t\t\t");
...
method Main()
{
    ...
    while n <= 10
    {
        var inputParameters := InputSpace(n);
        var initialState := rho(inputParameters);
        var terminalState := FiboRecTransitionSystem(initialState);
        var output:nat := pi(terminalState);
        //assert output == fibo(n);
        //print(output);
        //print("\t");
