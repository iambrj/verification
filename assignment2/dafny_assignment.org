...
method baseCaseTransit(currentState:StateSpace) returns (terminalState:StateSpace)
// pre-conditions:
    requires currentState.a == 0
    requires currentState.b == fibo(currentState.d)
    requires currentState.c == fibo(currentState.d + 1)
    requires currentState.d >= 0
// post-conditions:
    ensures terminalState.b == fibo(currentState.d)
{
    terminalState := StateSpace(0, currentState.b, currentState.c,
                           currentState.d);
}
// Transition System
    ...
    ensures nextState.b == fibo(currentState.d)
{
    if currentState.a < 1
    {
        nextState := baseCaseTransit(currentState);
    }
    else
    {
